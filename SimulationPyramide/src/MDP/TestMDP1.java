...
public class TestMDP1 {
	...
	public static void main(String[] args) throws IOException {
		...
		nbVisitesMoyenne=nbVisitesMoyenne/listeEtats.size();
		System.out.println("Nombre d'états dans le MDP : "+listeEtats.size());
