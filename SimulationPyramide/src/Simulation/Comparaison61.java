...
public class Comparaison61 {
	public static void main(String[] args) throws IOException{
	    ...
	    VariablesGlobales.writer_gmpm=new FileWriter("comp61-gmpm.csv",true);
		Gantt gantt;
	    ...
	    VariablesGlobales.writer_pl2p=new FileWriter("comp61-pl2p.csv",true);
	    Cout cout=new Cout();
		Gantt gantt;
