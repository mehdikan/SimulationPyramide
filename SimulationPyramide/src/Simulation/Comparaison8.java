...
public class Comparaison8 {
	public static void main(String[] args){		
		...
		Requete req=new Requete(50000,30);
	    req.rajouterJob(new Job(req,3,1,4,2,8*2,8*512,8*512,8*1,8*256,8*256));
		...
		/*ModelePlacementGLPKV7 mo=new ModelePlacementGLPKV7(cloud);
		long startTime = System.currentTimeMillis();
		mo.resoudre();
		long stopTime = System.currentTimeMillis();
	    long elapsedTime = stopTime - startTime;
