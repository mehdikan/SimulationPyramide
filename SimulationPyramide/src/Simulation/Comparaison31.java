...
public class Comparaison31 {
	public static void main(String[] args) throws IOException{
		...
		if(v==1){
			VariablesGlobales.writer_gbrt=new FileWriter("comp31-gbrt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_gmpt=new FileWriter("comp31-gmpt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_gmpm=new FileWriter("comp31-gmpm.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_pl2p=new FileWriter("comp31-pl2p.csv",true);
		    Cout cout=new Cout();
			Gantt gantt;
