...
public class Comparaison71 {
	public static void main(String[] args) throws IOException{
		...
		Requete req=new Requete(0.25,45);
		...
		if(v==1){
			VariablesGlobales.writer_gbrt=new FileWriter("comp71-gbrt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_gmpt=new FileWriter("comp71-gmpt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_gmpm=new FileWriter("comp71-gmpm.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_pl2p=new FileWriter("comp71-pl2p.csv",true);
		    Cout cout=new Cout();
			Gantt gantt;
