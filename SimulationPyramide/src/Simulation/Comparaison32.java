...
public class Comparaison32 {
	public static void main(String[] args) throws IOException{		
		...
		Requete req=new Requete(1.5,35);
		...
		if(v==1){
			VariablesGlobales.writer_gbrt=new FileWriter("comp32-gbrt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_gmpt=new FileWriter("comp32-gmpt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_gmpm=new FileWriter("comp32-gmpm.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_pl2p=new FileWriter("comp32-pl2p.csv",true);
		    Cout cout=new Cout();
			Gantt gantt;
