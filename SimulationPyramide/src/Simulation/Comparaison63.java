...
public class Comparaison63 {
	public static void main(String[] args) throws IOException{
		...
		Requete req=new Requete(0.3,35);
		...
		if(v==1){
			VariablesGlobales.writer_gbrt=new FileWriter("comp63-gbrt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_gmpt=new FileWriter("comp63-gmpt.csv",true);
			Gantt gantt;
		    ...
		    VariablesGlobales.writer_pl2p=new FileWriter("comp63-pl2p.csv",true);
		    Cout cout=new Cout();
			Gantt gantt;
